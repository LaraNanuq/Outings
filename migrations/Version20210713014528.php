 ...
 */
final class Version20210713014528 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, campus_id INT NOT NULL, alias VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, first_name VARCHAR(50) NOT NULL, email VARCHAR(250) NOT NULL, password VARCHAR(50) NOT NULL, phone VARCHAR(15) DEFAULT NULL, picture_url VARCHAR(1000) DEFAULT NULL, is_disabled TINYINT(1) NOT NULL, roles JSON NOT NULL, UNIQUE INDEX UNIQ_8D93D649E16C6B94 (alias), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649AF5D55E1 (campus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
